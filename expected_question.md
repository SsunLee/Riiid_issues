...
저같은 경우에는 통합관제시스템 APP을 담당하여 진행 하였습니다.

[성격 소개]
두 번째로 저의 성격을 표현하자면,
저는 평화주의자 라고 생각하고 있습니다. 
주변에 적을 만들기 싫어하구요. 

두루두루 친하게 지내는 지내는 것을 좋아해서 인 것 같습니다.
...
마지막으로  
저의 업무 스타일은 이렇습니다.
개발지식을 통해서 개발자 관점기반으로 프로그램을 들여다보고, 
새로운 것을 좋아하는 사용자 입장에서도 프로그램을 들여다봅니다.
막히는 것이 있다면, 구글링을 통해서 문제를 해결하는 편 입니다.

저의 업무 방식이나 지식이 뤼이드와 맞아서 
도움이 되었으면 좋겠습니다.
